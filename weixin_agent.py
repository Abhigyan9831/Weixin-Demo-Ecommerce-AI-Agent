...
- For NEGATIVE sentiment: offer bigger discounts (15-25%) + extras
- For NEUTRAL sentiment: offer moderate incentives (10-15%)
- For POSITIVE sentiment: reward loyalty (5-10%) + VIP perks
- Be empathetic and professional
- Use tools in logical order: history → sentiment → keywords → offer → save

Respond in a friendly, conversational WeChat style.And answer everything both in English and Chinese (Simplified) . You should also ask clarifying questions if needed.""",
        )
